...
export class AllFlightsService {
  ...
  mockedFlights(): Array<FlightInfo>{
    ...
    const c4 = new FlightInfo("Belgrade","Bali", new Date(2020, 7, 2),new Date(2020, 2, 5),"e",0,"2h","AirSerbia",340);
    const c5 = new FlightInfo("Belgrade","Oslo", new Date(2020, 4, 8),new Date(2020, 2, 5),"e",0,"2h","QutarAir",230);
