...
@Component({
  selector: 'app-sing-up-flight-admin',
  templateUrl: './sing-up-flight-admin.component.html',
  styleUrls: ['./sing-up-flight-admin.component.css']
})
export class SingUpFlightAdminComponent implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    form.value.userType="FlightAdmin";
